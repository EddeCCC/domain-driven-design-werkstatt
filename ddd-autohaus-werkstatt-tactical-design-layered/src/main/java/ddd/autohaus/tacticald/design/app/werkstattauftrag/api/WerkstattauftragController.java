package ddd.autohaus.tacticald.design.app.werkstattauftrag.api;
...
import ddd.autohaus.tacticald.design.app.werkstattauftrag.model.auftragsstatus.AuftragsstatusDTO;
import ddd.autohaus.tacticald.design.app.werkstattauftrag.service.WerkstattauftragService;
...
public class WerkstattauftragController {
    ...
    public ResponseEntity<String> updateStatus(@RequestBody AuftragsstatusDTO dto, @PathVariable(value = "auftragsnummer") long auftragsNummer) {
        String neuerStatus = dto.getStatus();
